...
namespace QuizAPI.Controllers
{
	...
	public class ParticipantController : ControllerBase
	{
		...
		public async Task<IActionResult> PutParticipant(int id, ParticipantDTO _participantDto)
		{
			if (id != _participantDto.ParticipantId)
			{
				return BadRequest();
			}

			Participant? participant = _context.Participants.Find(id);
			participant.Score = _participantDto.Score;
			participant.TimeTaken = _participantDto.TimeTaken;
